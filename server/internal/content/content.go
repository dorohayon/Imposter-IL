...
var Categories = []Category{
	...
	{"technology_digital", "טכנולוגיה ודיגיטל", []string{"סמארטפון", "טאבלט", "לפטופ", "שעון חכם", "אוזניות", "וויי פיי", "בלוטוס", "נתב", "ג'יפיאס", "איירדרופ", "מטען", "כבל", "סוללה", "מתאם", "פאוור בנק", "מצלמה", "זיהוי פנים", "פנס", "התראה", "צילום מסך", "וואטסאפ", "טלגרם", "אינסטגרם", "טיקטוק", "דיסקורד", "דפדפן", "גוגל", "חיפוש", "טאבים", "קוקיז", "סיסמה", "קוד אימות", "הצפנה", "פיירוול", "אנטי וירוס", "ענן", "גיבוי", "אחסון", "סנכרון", "הורדה", "מודל", "פרומפט", "צ'אט בוט", "מחולל תמונות", "עוזר קולי", "גיטהאב", "דוקר", "ממשק", "שרת", "מסד נתונים"}},
