...
**APK לבודקים:** `flutter build apk --release --dart-define=TEST_ADS=true` מציג
מודעות בדיקה של Google. אפליקציית AdMob חדשה אינה מגישה מודעות אמיתיות עד שהיא
מקושרת לדף חנות שפורסם. **לעולם לא בבנייה לחנות.**
