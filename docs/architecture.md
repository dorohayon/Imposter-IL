...
סיבות סיום (`EndReason`): `impostor_not_caught`, `impostor_parity`, `impostor_guessed_word`, `impostor_guess_wrong`, `impostor_guess_timeout`, `impostor_gone`, `not_enough_players`.

תוצאה לכל שחקן: שחקן שיצא או הוצא — הפסד. שחקן שהודח בהצבעה — התוצאה של הקבוצה שלו. ניצחון אזרחים — כל האזרחים שנשארו ושהודחו מנצחים. ניצחון מתחזה — המתחזה מנצח והאזרחים מפסידים. `not_enough_players` — כל הנשארים מנצחים.
