...
עדיין פתוח ([`open-decisions.md`](open-decisions.md#שאלות-שעלו-בתכנון-מנוע-המשחק)): טיימר לחשיפת תפקיד. עד להחלטה אין טיימר, והערך ניתן להגדרה ב־`RoleRevealTimeout`.
