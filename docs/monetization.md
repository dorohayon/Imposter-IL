...
- האפליקציה שולחת את ההוכחות של החנות ל־`POST /v1/entitlements` כשמשהו השתנה
  ...
  חותם מחדש את אותה עסקה בכל שחזור. השליחה סדרתית: בקשה אחת בכל פעם, ולא יותר
  מאחת ממתינה.
...
- **תחילת משחק בחדר פרטי:** הקטגוריות נבדקות שוב מול מי שבחר אותן. מנהל שקיבל
  את החדר בהעברה לא בחר אותן, וההגדרות כבר נעולות, ולכן החדר ממשיך עם מה שהיוצר
  פתח.
