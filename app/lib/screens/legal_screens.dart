...
class TermsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const _LegalDocument(
      title: 'תנאי שימוש',
      intro:
          'גרסה $legalVersion · בתוקף מ־$legalDate\n\nהשימוש ב״מי המתחזה?״ כפוף לתנאים הבאים. המשחק אינו מיועד למי שטרם מלאו לו 13. אם מלאו לכם 13 אך אינכם בגיל שמאפשר לכם להסכים לתנאים במקום מגוריכם, השתמשו במשחק רק באישור ובהשגחת הורה או אפוטרופוס.',
      sections: [
        _LegalSection(
          '1. השירות',
          '״מי המתחזה?״ הוא משחק חברתי מקוון המופעל על ידי דור אוחיון, מפתח עצמאי (imposteril36@gmail.com). אין צורך בחשבון. אתם בוחרים כינוי ואווטאר ומקבלים מזהה אורח זמני לצורך המשחק.',
        ),
        _LegalSection(
  ...
  Widget build(BuildContext context) {
    return const _LegalDocument(
      ...
      sections: [
        _LegalSection(
          '1. מי אנחנו',
          'המשחק ״מי המתחזה?״ מופעל על ידי דור אוחיון, מפתח עצמאי, והמדיניות הזאת חלה על האפליקציה ועל השרת שמפעיל אותה. לפניות בנושא פרטיות: imposteril36@gmail.com.',
        ),
        _LegalSection(
          '2. מידע שנשמר במכשיר',
        ...
        _LegalSection(
          '7. שירותים חיצוניים',
          'השרת מתארח ב־Google Cloud Platform (Cloud Run, אזור us-central1), וגוגל מעבדת מידע טכני הנדרש להעברת התעבורה ולשמירת הלוגים התפעוליים, כמעבדת מידע מטעמנו ובכפוף להתחייבויות אבטחה ופרטיות ברמה זהה או טובה יותר מזו שמתוארת כאן. אין העברת מידע לצדדים שלישיים נוספים. בגרסה 1.0 אין SDK פרסום, אין מכירת מידע אישי ואין SDK צד שלישי ל־analytics או crash reporting. אם יתווסף שירות כזה, המדיניות ורישומי החנויות יעודכנו לפי הצורך.',
        ),
        _LegalSection(
          '8. ילדים ופרטים אישיים',
          'המשחק אינו מבקש שם אמיתי או פרטי קשר. אין לכתוב בכינוי או ברמז מידע אישי שלכם או של אחרים. המשחק אינו מיועד לילדים מתחת לגיל 13, ואיננו אוספים ביודעין מידע מהם. בין גיל 13 לגיל שבו אפשר להסכים באופן עצמאי במקום מגוריכם, השתמשו במשחק באישור ובהשגחת הורה או אפוטרופוס. אם נודע לנו שילד מתחת לגיל 13 שיחק, נמחק את המידע הקשור אליו.',
        ),
        _LegalSection(
          '9. בחירה ושליטה',
